...
class ChainStatusManager {
    ...
    try {
      ...
      const nodeStatuses = nodes.map((node2) => {
        ...
        return {
          ...
          error: (adapter == null ? void 0 : adapter.error) || void 0,
          connectTime: (adapter == null ? void 0 : adapter.startTime) || void 0
        };
      });
      ...
      const chainStatus = {
        ...
        totalTraffic,
        startTime: middlewareStatus.startTime || void 0,
        error: middlewareStatus.error || void 0
      };
   ...
   * 执行定期检测
   */
  async performPeriodicDetection() {
    try {
      const activeChains = Array.from(this.chainStatuses.values()).filter((chain) => chain.status === "running");
