...
export class DefaultSettings {
  ...
  static getDefaultAppSettings(): AppSettings {
    return {
      ...
      // HTTP/2 防护默认配置（与 HttpProtocolManager 对齐）
      enableHttp2Protection: true,
      http2ProtectionMode: 'strict',
      http2ConnectionIsolation: true,
      http2HeaderTableCleanup: false,
      http2TimingObfuscation: false,
      http2SensitiveDomains: [],
      http2ProtocolWhitelist: [],
      http2ForceHttp1: false,
      http2BatchRequests: false,
      http2BatchSize: 0,
      http2BatchDelayRange: [0, 0] as [number, number],
      http2ConnectionResetInterval: 0,
      enableUdp: true,
      enableIpv6: false,
      enableTun: false,
      tunDevice: 'utun0',
